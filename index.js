  ...
  try {
      ...
      if (text === '/contacts') {
          return bot.sendMessage(chatId, ` Директор:	Присяжнюк Володимир Петрович	(0432) 65 11 12 \n
                                           ...
                                           \nРеєстратура: Жіночої консультації (+38) 0988518082\n`);
      }
