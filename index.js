...
const bot = new telegram(process.env.TELEGRAM_TOKEN, {polling: true})
      ...
      bot.on('message', async msg => {
              ...
              try {
                  ...
                  if (text === '/contacts') {
                      return bot.sendMessage(chatId, ` %0A Директор	Присяжнюк Володимир Петрович	65 11 12
                                                       %0A Медичний директор	Бардаш Леся Юріївна	65 11 22
                                                       %0A Заступник медичного директора з педіатрії	Опіопченко Світлана Федорівна	65 11 12
                                                       %0A Заступник директора з економічних питань	Дунаєва Ірина Дмитрівна	65 11 20
                                                       %0A Заступник директора з технічних питань	Руденко Марина Олександрівна	65 11 23
                                                       %0A Головна медична сестра	Коваль Ірина Анатоліївна	65 11 36
                                                       %0A Головний бухгалтер	Костюк Людмила Володимирівна	65 11 19
                                                       %0A Начальник відділу кадрів	Ключківська Тетяна Володимирівна	65 11 36`);
                  }
